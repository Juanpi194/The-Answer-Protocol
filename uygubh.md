1. Nivel jugador (Relacionado con enemigo)
2. Distintos tipos de salas
3. Chest (en las salas de chest duh) -> Items aleatorios
4. Distintos tipos de enemigos
5. XP
6. Monedas en cofres
7. Porcentaje de uso de items
8. Items:
    - Armaduras (fuego, espinas)
    - Espadas (fuego, filo, luz)
    - Escudo (Proteccion plus plus)

        <img src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExYWljb2d3NnBrMWpldmVxZ2JuNHg0MWN0Z21iNTJteGN5Mmt0Y3ZwbiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/JMO0yh1HZDXRDt2hZ5/giphy.gif" width="100"/>

9. Npcs (1 POR SALA)
    - Narrador
    - Enchanter (Permanente)
    - Mercancia (Armaduras, Armas, Pociones...)
    - El de las misiones
    - Enemigos
        - Mago de fuego (medium) (Te queman, son debiles a obj de hielo)
        - Mago de hielo (medium) (Congelar, son debiles a obj de fuego)
        - Duendes (low) (lentos, debiles y dan veneno)
        - Hogros (medium) (lentos, resistencia y pegan duro)
        - Sombras (low) (Agiles, Probabildad que los golpes fallen [Golpes de luz no fallan])
        - Lobo (low) (Agiles, dan daño por sangrado, pero los matas facilito)
        - Dragón (high) ()

10. A elegir pack inicial de items
11. Estados
    - Agarrado ()
    - Sangrado ()
    - Paralizado ()
